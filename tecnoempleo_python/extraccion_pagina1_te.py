...
# Primero vemos cómo acceder a los enlaces de la primera página:
...
for link in urls:
    ...
    # Tecnologías. En el caso de tecnologías, limpiamos ya la información que sacamos para que nos muestre solo la tecnología sin el texto que no es necesario: "Ofertas de Empleo de":
